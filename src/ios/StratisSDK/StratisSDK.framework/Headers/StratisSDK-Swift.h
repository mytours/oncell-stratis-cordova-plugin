...
- (void)nearbyReaders:(NSArray<WaveLynxReader *> * _Nonnull)rIdentifiers;
@end
...
/// This delegate provides results for device status which was initiated by calling <code>retrieveDeviceStatus</code>.
SWIFT_PROTOCOL("_TtP10StratisSDK35StratisDeviceRetrieveStatusDelegate_")
@protocol StratisDeviceRetrieveStatusDelegate
/// Called when a device stauts are retrieved.
/// \param stratisSDK A reference to the instance of the <code>StratisSDK</code> that produced this result.
///
/// \param devices A collection of <code>StratisLock</code>s for which status are retrieved.
///
- (void)stratisDiscoveredDeviceStatus:(StratisSDK * _Nonnull)stratisSDK devices:(NSArray<StratisLock *> * _Nonnull)devices;
/// Called when the device status retrieve operation has encountered an error.
/// \param stratisSDK A reference to the instance of the <code>StratisSDK</code> that produced this result.
///
/// \param error A <code>StratisError</code> instance.
///
- (void)stratisDeviceStatusRetrieveEncounteredError:(StratisSDK * _Nonnull)stratisSDK error:(StratisError * _Nonnull)error;
@end
...
SWIFT_CLASS("_TtC10StratisSDK14WaveLynxReader")
@interface WaveLynxReader : BLELock
@end


/// Represents a Zwave lock which is locked / unlocked with use of wireless mesh network.
SWIFT_CLASS("_TtC10StratisSDK9ZwaveLock")
@interface ZwaveLock : StratisLock
@end
